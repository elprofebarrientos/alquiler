...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('proveedores', function (Blueprint $table) {
            ...
            $table->foreign('id_pais')->references('id')->on('countries')->nullOnDelete();
            $table->foreign('id_departamento')->references('id')->on('departments')->nullOnDelete();
            $table->foreign('id_municipio')->references('id')->on('cities')->nullOnDelete();
        });
    }
